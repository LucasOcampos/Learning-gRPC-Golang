...
const (
	PrimeService_PrimeDecomposition_FullMethodName = "/primes.PrimeService/PrimeDecomposition"
)
...
func (c *primeServiceClient) PrimeDecomposition(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (PrimeService_PrimeDecompositionClient, error) {
	stream, err := c.cc.NewStream(ctx, &PrimeService_ServiceDesc.Streams[0], PrimeService_PrimeDecomposition_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
